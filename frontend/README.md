...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Lyqhpm1Nro)
...
```sh
npx nx serve parking
```

To create a production bundle:

```sh
npx nx build parking
```

To see all available targets to run for a project, run:

```sh
npx nx show project parking
```
